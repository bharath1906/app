...
## Online Build
- **Netlify**: Upload the `mathlens-web` folder; it auto-detects `index.html` at root and deploys.
- **Vercel**: Upload the `mathlens-web` folder; it auto-detects `index.html` at root and deploys.
