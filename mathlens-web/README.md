...
## Online Build
- **Netlify**: Upload the `public` folder (inside `mathlens-web`); it contains the built web app files.
- **Vercel**: Upload the `public` folder (inside `mathlens-web`); it contains the built web app files.
